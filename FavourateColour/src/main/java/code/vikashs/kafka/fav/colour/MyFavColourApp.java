package code.vikashs.kafka.fav.colour;
...
public class MyFavColourApp {
	 ...
	 public static void main(String[] args) {
	        ...
	        KStream<String, String> textLines = builder.stream("favColour-input");
	        ...
	        favouriteColours.to(Serdes.String(), Serdes.Long(),"favColour-output");
